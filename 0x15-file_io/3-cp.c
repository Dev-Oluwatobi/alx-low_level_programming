...
/**
 * check97 -  the right number of arguments
 * @argc: whole arguements
 *
 * Return: void
 */
...
/**
 * check98 - this parameter checks that file_from exists and can be read
...
/**
 * check99 - this function checks that file_to was created.
 * @check: if true of false
 * @file: file_to name
 * @fd_from: file descriptor of file_from, or -1
 * @fd_to: file descriptor of file_to, or -1
...
/**
 * main - this parameter copies the content of a file to another file.
